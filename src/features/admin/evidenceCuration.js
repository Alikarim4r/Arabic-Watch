...
export const EVIDENCE_SPRINT_BATCHES = [
  ...
  {
    id: 'evidence_all_batches',
    label_ar: 'كل الدفعات',
    patchPath: 'examples/evidence_patch.all_batches.proposed.json',
    reviewTemplatePath: 'examples/evidence_patch.all_batches.owner_review_template.json',
    csvPath: 'examples/evidence_patch.all_batches.owner_review.csv',
